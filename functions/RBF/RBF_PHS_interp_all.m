function [D_all] = RBF_PHS_interp_all(xy1,xy_s,Nearest_Idx,k,m,d)

% RBF_PHS_INTERP_ALL  RBF-FD-based (PHS+poly) global differentiation matrices


%   [D_ALL] = RBF_PHS_INTERP_ALL(XY1,XY_S,NEAREST_IDX,K,M,D,VARARGIN) returns
